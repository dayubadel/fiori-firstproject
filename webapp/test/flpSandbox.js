		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Invoices List",
									"targetURL": "#dayanainvoice-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"dayanainvoice-display": {
								"semanticObject": "dayanainvoice",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=dayana.invoice",
									"url": sap.ui.require.toUrl("dayana/invoice")
								}
							}
						}
					}
